...
/*   Updated: 2024/09/03 22:01:59 by smontuor         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
//--- Copy Constructor
//--- Default Destructor
ClapTrap::ClapTrap() : _name("NoName"), _hitPoints(10), _energyPoints(10), _attackDamage(0) {dbgPrint("Default ClapTrap constructor called");}
ClapTrap::ClapTrap(std::string name) : _name(name), _hitPoints(10), _energyPoints(10), _attackDamage(0) {dbgPrint("ClapTrap Constructor overload called");}
ClapTrap::ClapTrap(const ClapTrap &other) : _name(other._name), _hitPoints(other._hitPoints), _energyPoints(other._energyPoints), _attackDamage(other._attackDamage) {dbgPrint("ClapTrap Copy constructor called");}
ClapTrap::~ClapTrap() {dbgPrint("Default ClapTrap destructor called");}

// Overload operator
//--- Assignation operator
ClapTrap &ClapTrap::operator=(const ClapTrap &other)
{
	dbgPrint("ClapTrap Assignation operator called");
	if (this == &other)
		return (*this);
	_name = other.getName();
